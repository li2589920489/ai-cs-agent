...
export function AgentPanel({
  ...
  return (
    <div className="w-[35%] h-full flex flex-col border-r border-gray-200 bg-white rounded-xl shadow-sm">
      <div className="bg-orange-500 text-white h-12 px-4 flex items-center gap-3 shadow-sm rounded-t-xl">
